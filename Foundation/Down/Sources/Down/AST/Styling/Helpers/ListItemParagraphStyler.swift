...
//
    ...
    public class ListItemParagraphStyler {
        ...
        public var indentation: CGFloat {
            largestPrefixWidth + options.spacingAfterPrefix
        }
        ...
        public init(options: ListItemOptions, prefixFont: DownFont) {
            ...
            largestPrefixWidth = prefixFont.widthOfNumberedPrefix(digits: options.maxPrefixDigits)
        }
        ...
        private func tabStop(at location: CGFloat) -> NSTextTab {
            NSTextTab(textAlignment: .left, location: location, options: [:])
        }
    }
