...
//
    ...
    open class DownStyler: Styler {
        ...
        open func style(document _: NSMutableAttributedString) {}
        ...
        open func style(list _: NSMutableAttributedString, nestDepth _: Int) {}
        ...
        open func style(codeBlock str: NSMutableAttributedString, fenceInfo _: String?) {
        ...
        open func style(customBlock _: NSMutableAttributedString) {}
        ...
        open func style(softBreak _: NSMutableAttributedString) {}

        open func style(lineBreak _: NSMutableAttributedString) {}
        ...
        open func style(customInline _: NSMutableAttributedString) {}
