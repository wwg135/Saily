    ...
    var popupInteractionStyle: PopupInteractionStyle {
        ...
        set {
            ...
            case .snap:
                ...
                return
            case let .customizedSnap(percent):
                __popupInteractionStyle = .snap
...
public extension LNPopupItem {
    ...
    var attributedTitle: AttributedString? {
        get {
            __attributedTitle != nil ? AttributedString(__attributedTitle!) : nil
        }
        set {
    ...
    var attributedSubtitle: AttributedString? {
        get {
            __attributedSubtitle != nil ? AttributedString(__attributedSubtitle!) : nil
        }
        set {
...
public extension LNPopupBarAppearance {
    ...
    var titleTextAttributes: AttributeContainer? {
        get {
            __titleTextAttributes != nil ? AttributeContainer(__titleTextAttributes!) : nil
        }
        set {
    ...
    var subtitleTextAttributes: AttributeContainer? {
        get {
            __subtitleTextAttributes != nil ? AttributeContainer(__subtitleTextAttributes!) : nil
        }
        set {
