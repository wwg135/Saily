...
//
    ...
    public final class DropDown: UIView {
        ...
        public weak static var VisibleDropDown: DropDown?
        ...
        /**
         Alias method for `shadowOpacity` variable to avoid ambiguity.
         */
    ...
    public extension DropDown {
         ...
         */
        @discardableResult
        func show(onTopOf window: UIWindow? = nil, beforeTransform transform: CGAffineTransform? = nil, anchorPoint: CGPoint? = nil) -> (canBeDisplayed: Bool, offscreenHeight: CGFloat?) {
    ...
    public extension DropDown {
        ...
        @objc func selectRow(_ index: Int, scrollPosition: UITableView.ScrollPosition = .none) {
            selectRow(at: Index(index), scrollPosition: scrollPosition)
        }
